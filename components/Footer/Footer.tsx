...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-900">
        ...
        <div className="grid md:grid-cols-3 gap-7 ">
          <div>
            <Link href="/" className="mb-10 block">
              <Image src={logo} width={128} height={49} alt="logo"></Image>
            </Link>
            <p className="text-gray-400">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Numquam
              vero amet natus ipsa reprehenderit voluptatem!
            </p>
          </div>
          <div>
      ...
      <div className="max-w-screen-xl mx-auto px-4 border-t border-b-gray-500 py-8 text-center text-base text-gray-500">
        &copy; Copyright {year} | Ahmad Sabili Alghifari
      </div>
    </footer>
  );
};
