      ...
      <div
        ...
        <ul className="flex flex-col font-semibold text-sm uppercase p-4 mt-4 rounded-sm bg-gray-50 md:flex-row md:items-center md:space-x-10 md:p-0 md:mt-0 md:border-0 md:bg-white">
          <li>
            <Link
              href="/"
              className="block py-2 px-3 text-gray-800 hover:bg-amber-100 rounded-sm md:hover:bg-transparent md:p-0">
              Home
            </Link>
          </li>
          ...
          <li className="pt-2 md:pt-0">
            <Link
              href="/signin"
              className="py-2.5 px-2.5 bg-orange-400 text-white hover:bg-orange-500 rounded-sm">
              Sign in
            </Link>
          </li>
        </ul>
